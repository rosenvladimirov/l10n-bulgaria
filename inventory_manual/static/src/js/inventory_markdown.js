...
markdownRegistry.register(
    'stock_handover_protocol',
    'inventory_manual',
    'stock_handover_protocol.md',
    'Handover Protocol (Приемно-предавателен протокол)',
    'Inventory',
    'Printing the handover protocol from a stock picking (l10n_bg_report_stock).',
    STOCK_MODELS
);
