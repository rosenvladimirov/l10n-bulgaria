...
class TestUNCRImport(TransactionCase):
    """Run test to import MT940 UNCR import."""

    def setUp(self):
        super(TestUNCRImport, self).setUp()
    ...
    def test_statement_import(self):
        ...
        brd_file_path = get_module_resource(
            'l10n_bg_account_bank_statement_import_mt940_uncr',
            'test_files', 'test_uncr_940.txt')
