...
class BGVatPurchaseReport(models.Model):
    ...
    tag_03_01 = fields.Char(
        "[03-01] Tax period", readonly=True, help="Report tax period"
    )
    tag_03_02 = fields.Char(
        "[03-02] VAT Company",
        readonly=True,
        help="VAT identification number of the company",
    )
    tag_03_03 = fields.Integer(
        "[03-03] Office", readonly=True, help="Office/detached unit"
    )
    tag_03_04 = fields.Integer(
        "[03-04] Number by order",
        readonly=True,
        help="Serial number of the document in the journal",
    )
    tag_03_05 = fields.Char(
        "[03-05] Type of document", readonly=True, help="Type of original document"
    )
    tag_03_06 = fields.Char(
        "[03-06] Document number", readonly=True, help="Number of original document"
    )
    tag_03_07 = fields.Date(
        "[03-07] Document date", readonly=True, help="Date of original document"
    )
    tag_03_08 = fields.Char(
        "[03-08] ID of the partner",
        readonly=True,
        help="Identification number of the partner (supplier)",
    )
    tag_03_09 = fields.Char(
        "[03-09] Name of partner", readonly=True, help="Name of partner (supplier)"
    )
    tag_03_10 = fields.Char(
        "[03-10] Product type",
        readonly=True,
        help="Type of goods or scope and type of service "
        "- exact description according to the document",
    )
    tag_03_12 = fields.Float(
        "[03-12] Tax base of supplies received",
        readonly=True,
    ...
    tag_03_11 = fields.Float(
        "[03-11] VAT with the right to a full tax credit",
        readonly=True,
        help="Charged VAT 20% with the right to use the full tax credit",
    )
    tag_03_13 = fields.Float(
        "[03-13] VAT with the right to a partial tax credit",
        readonly=True,
        help="Charged VAT 20% with the right to use a partial tax credit",
    )
    tag_03_14 = fields.Float(
        "[03-14] Annual adjustment",
        readonly=True,
        help="Annual adjustment under Art. 73, para. 8 VAT",
    )
    tag_03_15 = fields.Float(
        "[03-15] Trilateral operation",
        readonly=True,
        help="Tax base when acquiring goods from an intermediary in a tripartite transaction",
    )
    tag_03_30 = fields.Float(
        "[03-30] Tax basis - no right to tax credit",
        readonly=True,
    ...
    tag_03_31 = fields.Float(
        "[03-31] Tax basis - full tax credit",
        readonly=True,
    ...
    tag_03_41 = fields.Float(
        "[03-41] VAT - full tax credit",
        readonly=True,
        help="VAT with the right to a full tax credit",
    )
    tag_03_32 = fields.Float(
        "[03-32] Tax base - partial tax credit",
        readonly=True,
    ...
    tag_03_42 = fields.Float(
        "[03-42] VAT-partial tax credit",
        readonly=True,
        help="VAT with the right to a partial tax credit",
    )
    tag_03_43 = fields.Float(
        "[03-43] Annual adjustment - art. 73, paragraph 8",
        readonly=True,
        help="Annual adjustment under Art. 73, para. 8 Law of VAT",
    )
    tag_03_44 = fields.Float(
        "[03-44] Tax base tripartite operation",
        readonly=True,
        help="Tax base when acquiring goods from an intermediary in a tripartite transaction",
    )
    tag_03_45 = fields.Char(
        "[03-45] Trilateral operation",
        readonly=True,
        help="Tax basis when acquiring goods from an intermediary in a tripartite transaction",
    )
    tag_03_80 = fields.Char(
        "[03-8а] Tax base - art. 163a",
        readonly=True,
