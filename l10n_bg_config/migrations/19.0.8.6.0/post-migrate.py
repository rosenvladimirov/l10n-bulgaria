...
"""Upgrade-time setup for l10n_bg_config 19.0.8.6.0.

The registered-client push (19.0.8.6.0) wires its recurring trigger in
...
def migrate(cr, version):
    ...
    _logger.info(
        "l10n_bg_config 19.0.8.6.0 post-migrate: registration cron wired "
