...
"""Upgrade-time setup for l10n_bg_config 19.0.8.6.3.
...
def migrate(cr, version):
    ...
    _logger.info("l10n_bg_config 19.0.8.6.3 post-migrate: registration cron ensured (own active if publisher inactive)")
