...
SECTOR_XMLID = "l10n_bg_config.kid_2025_A"


def post_init_hook(env):
    """Активира КИД сектор 'A' за всяка BG фирма и презарежда сметкоплана.
    ...
    for company in env["res.company"].search([]):
        ...
        try:
            ...
            _logger.info(
                "Industry plugin: КИД 'A' preset + chart reloaded for %s",
                company.name,
            )
