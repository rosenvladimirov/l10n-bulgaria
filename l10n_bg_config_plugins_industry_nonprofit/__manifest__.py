...
{
    "name": "Bulgaria - Industry Pack: Non-profit (ЮЛНЦ)",
    "summary": """
        Industry configuration pack for КИД sector S (Non-profit (ЮЛНЦ)):
...
What it does
------------
* On install, adds КИД section **S** to every Bulgarian company's
  *Active КИД sectors* (``res.company.l10n_bg_kid_ids``) and reloads
  the chart of accounts, so the "one chart, many КИД" install filter
  (``l10n_bg_config``) lets sector S's sector-specific accounts
  through.
* Is the designated home for sector S's accounting content shipped
