...
// IMPORTANT: do NOT add `export` in front of the class. Odoo's bundle
// minifier mangles `export class X extends Component` into a call form
// that ES strict-mode rejects with: "class constructors must be invoked
// with 'new'". Plain `class X extends Component` builds fine.
