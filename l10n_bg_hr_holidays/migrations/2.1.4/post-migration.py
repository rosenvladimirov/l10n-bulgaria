...
# Предишната миграция (1.9.0) ги пропускаше с future-guard → Odoo ги
...
# 20/master: hr_leave_allocation.work_entry_type_id (беше holiday_status_id)
# + таблица hr_work_entry_type (беше hr_leave_type).
...
def migrate(cr, version):
    cr.execute("""
        ...
        WHERE t.id = a.work_entry_type_id
