...
> **Текуща версия:** 19.0.4.1.0 · **Лиценз:** LGPL-3 · **Статус:** ядро
...
## Какво е НОВО в 19.0.4.x

* **19.0.4.1.0** — добавени три нови `account.payment.method` записа
  (`l10n_bg_infopay_domestic_bgn`, `_sepa_eur`, `_budget_bgn`),
  използвани от OCA + EE payment bridge-овете.
* **19.0.4.0.0** — **breaking** rename: всяко поле, което този модул
