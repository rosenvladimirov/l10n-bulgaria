...
> **Current version:** 19.0.4.1.0 · **License:** LGPL-3 · **Status:** core
...
## What's NEW in 19.0.4.x

* **19.0.4.1.0** — registers three new `account.payment.method`
  records (`l10n_bg_infopay_domestic_bgn`, `_sepa_eur`, `_budget_bgn`)
  consumed by the OCA + EE payment bridges.
* **19.0.4.0.0** — **breaking** field rename: every field this module
