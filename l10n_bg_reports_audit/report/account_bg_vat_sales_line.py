...
class AccountBGInfoSaleLine(models.Model):
    ...
    def _select(self):
        ...
        accs.account_tag_11 + accs.account_tag_13 + accs.account_tag_14 + accs.account_tag_17 + accs.account_tag_19 + accs.account_tag_21 + accs.account_tag_22 + accs.account_tag_23 + accs.account_tag_24 AS account_tag_9,
