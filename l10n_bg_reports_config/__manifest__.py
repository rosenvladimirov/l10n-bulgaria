{
    ...
    "data": [
        ...
        "views/account_bg_gfo_balance_line.xml",
        "views/account_bg_gfo_pl_line.xml",
        "views/account_bg_gfo_cf_line.xml",
        "views/account_bg_gfo_equity_line.xml",
        "views/account_bg_god_line.xml",
