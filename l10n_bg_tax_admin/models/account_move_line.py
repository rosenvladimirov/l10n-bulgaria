...
class AccountMoveLine(models.Model):
    ...
    l10n_bg_private_vat_invoice_id = fields.Many2one(
        "account.move",
    ...
    def _compute_price_unit_signed(self):
        for line in self:
            if line.move_id.currency_id == line.move_id.company_id.currency_id:
                ...
                line.price_unit_signed = line.move_id.company_id.currency_id.round(
                    line.price_unit / line.currency_rate
                )
    ...
    @api.depends(
        ...
        "tax_ids",
        "currency_id",
        "move_id.l10n_bg_protocol_invoice_id",
    )
    def _compute_totals_signed(self):
        for line in self:
            if line.display_type != "product":
                ...
                subtotal = line.move_id.company_id.currency_id.round(
