...
class AccountBGTotalPurchasesLine(models.Model):
    ...
    info_tag_5 = fields.Selection(selection=get_doc_type, string="[02-05] Vat type document", readonly=True)
    ...
    info_tag_10 = fields.Char(string='[02-10] Narration for audit report', readonly=True)
    info_tag_45 = fields.Selection(selection=get_delivery_type, string="[02-45] Vat type delivery", readonly=True)
    account_tag_30 = fields.Monetary(readonly=True, string='[02-30] Base for not entitled to a tax credit',
                                     currency_field='company_currency_id')
    account_tag_31 = fields.Monetary(readonly=True, string='[02-31] Base for full tax credit',
                                     currency_field='company_currency_id')
    account_tag_32 = fields.Monetary(readonly=True, string='[02-32] Base partly tax credit (~%)',
                                     currency_field='company_currency_id')
    account_tag_41 = fields.Monetary(readonly=True, string='[02-41] VAT for full tax credit',
                                     currency_field='company_currency_id')
    account_tag_42 = fields.Monetary(readonly=True, string='[02-42] VAT partly tax credit (~%)',
                                     currency_field='company_currency_id')
    account_tag_43 = fields.Monetary(readonly=True, string='[02-43] Correction of Art.73, para. 8',
                                     currency_field='company_currency_id')
