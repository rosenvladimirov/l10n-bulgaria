...
class AccountBGInfoSaleLine(models.Model):
    ...
    def _select(self):
        ...
        partner_name = l10n_bg_lang(self.env, "partner.name", lang_modules="partner", lang_code=lang_code)
        narration = l10n_bg_lang(self.env, "am.l10n_bg_narration", lang_modules="partner", lang_code=lang_code)
        ...
        {partner_name} AS info_tag_8,
        {narration} AS info_tag_9,
        am.l10n_bg_delivery_type AS info_tag_27,
        accs.account_tag_11 + accs.account_tag_121 + accs.account_tag_122 + accs.account_tag_13 + accs.account_tag_15 + accs.account_tag_16 + accs.account_tag_18 + accs.account_tag_19 AS account_tag_9,
        accs.account_tag_11 + accs.account_tag_121 + accs.account_tag_122 + accs.account_tag_13 + accs.account_tag_15 + accs.account_tag_16 + accs.account_tag_18 + accs.account_tag_19 AS account_tag_10,
        accs.account_tag_11,
...
{'GROUP BY ' + self._group() or ''}"""
    ...
    SUM(CASE
            WHEN am.state = 'cancel' THEN 0.00
            WHEN aml.balance < 0.0 AND aat.tag_name = 22 AND aat.negate THEN ABS(aml.balance)
            ...
            WHEN aml.balance > 0.0 AND aat.tag_name = 22 AND NOT aat.negate THEN aml.balance
            ELSE 0.00
