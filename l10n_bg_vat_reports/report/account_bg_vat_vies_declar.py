...
class AccountBGInfoViesDeclaration(models.Model):
    ...
    def _select(self):
        ...
        {l10n_bg_lang(self.env, lang_modules='partner', field_name='represent_partner.name', use_city_join=True)} AS info_tag_vdr_3,
        {l10n_bg_lang(self.env, lang_modules='partner', field_name='represent_partner.city', use_city_join=True)} AS info_tag_vdr_4,
        represent_partner.zip AS info_tag_vdr_5,
        {l10n_bg_lang(self.env, lang_modules='partner', field_name='represent_partner.street', use_city_join=True)} AS info_tag_vdr_6,
        ...
        {l10n_bg_lang(self.env, lang_modules='partner', field_name='company_partner.name', use_city_join=True)} AS info_tag_vtr_3,
        CONCAT ({l10n_bg_lang(self.env, lang_modules='partner', field_name='company_partner.city', use_city_join=True)}, ', ', {l10n_bg_lang(self.env, lang_modules='partner', field_name='company_partner.street', use_city_join=True)}) AS info_tag_vtr_4,
