...
## 🔗 Related
For printing the handover protocol at the order level — see *Handover Protocol on the Sale Order*. For the wording of items on the transport document — see *Order Line Wording on the Delivery Slip*.
