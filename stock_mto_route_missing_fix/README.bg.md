...
**Модул:** `stock_mto_route_missing_fix` | **Версия:** 18.0.1.0.0 | **Лиценз:** AGPL-3 | **Категория:** Inventory
...
Маршрутът е `active=False` по подразбиране в 18.0 — в UI се вижда само с филтър
...
Кодът не зависи от телата на методите, затова същият модул върви и на 19.0, и на
